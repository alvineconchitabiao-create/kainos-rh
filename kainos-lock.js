(function(){
  ...
  function init(){
    ...
    document.addEventListener('click', function(e){
      ...
      var bloque = e.target.closest('input, textarea, select, button, a');
      if(!bloque) return;
      e.preventDefault();
      e.stopPropagation();
      show();
